...
export const messages = {
  ...
  empty: {
    ...
    plugins: 'Activá un plugin desde Control Center.',
  ...
  errors: {
    ...
    ollamaDisabled: 'Ollama desactivado. Activalo en Control Center → Ollama.',
    ollamaUnreachable: 'Ollama no responde. Verificá que esté corriendo.',
    ollamaNoModel: 'Sin modelo seleccionado. Elegí uno en Control Center.',
  ...
  loading: {
    initializing: 'Inicializando Personal OS',
  ...
  onboarding: {
    ...
    pluginsHelp: 'Podés cambiar esto después en Control Center.',
    ...
    summaryHelp: 'Podés cambiar todo desde Control Center.',
